...
def main():
    ...
    ####
    r,c = newplot.new()
    ax = plot.subplot(fig=fig, grid=gs[r,c], func='sns.boxplot', data=iris, 
    ...
    ####
    r,c = newplot.new()
    ax = plot.subplot(fig=fig, grid=gs[r,c], func='sns.boxplot', data=dfs, 
                      pf_orient='h', 
    ...
    ####
    r,c = newplot.new()
    ax = plot.subplot(fig=fig, grid=gs[r,c], func='sns.barplot', data=iris, 
                      pf_x='species', pf_y='sepal_length',
    ...
    ####
    r,c = newplot.new()
    ax = plot.subplot(fig=fig, grid=gs[r,c], func='sns.barplot', data=dfs, 
                      pf_orient='h', 
                      pf_hue='characteristic', 
                      pf_y='species', pf_x='value',
                      ag_xmin=0,
    ...
    ax = plot.subplot(fig=fig, grid=gs[r,c], func='gpd.plot', data=counties, 
                      pf_column='intensity',
    ...
    ####
    r,c = newplot.new()
    ax = plot.subplot(fig=fig, grid=gs[r,c], func='sns.scatterplot', 
    ...
    ## X, Y = np.meshgrid(X, Y)
    ## Z = np.sin(X) * np.cos(Y)
    ## ax = plot.subplot(fig=fig, grid=gs[r,c], func='contour', 
    ...
    ####
    r,c = newplot.new()
    ax = plot.subplot(fig=fig, grid=gs[r,c], func='sns.countplot', data=iris, 
                      pf_x='species',
    ...
    ####
    r,c = newplot.new()
    ax = plot.subplot(fig=fig, grid=gs[r,c], func='sns.histplot', data=iris, 
                      pf_x='species',
