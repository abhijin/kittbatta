...
\newcommand{\onebyfive}{\tiny $1/5$}
\newcommand{\onebyfour}{\tiny $1/4$}
%
%
...
\begin{pgfonlayer}{fg}
\node (a14) [infected,label=left:$u$] at (-.1,-1.7){\vanish{14}};
\end{pgfonlayer}
\node (a15) [vertex] at (-.2,-2.7){\vanish{15}};

\node (a4) [infected,label=left:$v$] at (.5,-3){\vanish{4}};
...
\draw[dedge,red] (a4) -- (a6) node (a46) [midway] {};

\node (ew) at (2,-3.2) {\parbox{2.2cm}{\small colors represent edge weights}};
\draw[dedge,brown!80,->] (a46) -- ($(ew.north)+(-.5,0)$);%($(a4)+(0.2,0.4)$) -- (ew); 

\draw[dedge,red] (a4) -- (a15);
\draw[dedge,bend right,red] (a4) to (a14);
\draw[dedge,bend left] (a4) to (a14);
\draw[dedge,red] (a4) -- (a16);
\draw[dedge,red] (a4) -- (a17);
...
\begin{pgfonlayer}{fg}
\draw[dedge] (a7) -- (a14) node (a714) [midway] {};
\draw[dedge,brown!80,->] (a714) to (ew);%($(a4)+(0.2,0.4)$) -- (ew); 
\draw[dedge] (a6) -- (a14);
\end{pgfonlayer}
...
\draw[dedge] (1.3,.5) -- +(.25,0) node[right] {\onebyfour};
\draw[dedge,red] (1.3,.25) -- +(.25,0) node[right] {\onebyfive};
