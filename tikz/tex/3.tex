...
%
\draw[myedge] (b) -- (a) node[midway] (ref1) {};
\draw[myedge] (b) -- (c) node[midway] (ref2) {};
\draw[myedge] (c) -- (d);
%
...
% subtrees
\node (a) [treevertex,label=left:$a$,below=of
b,shift={(-.35,-1.25)},accepting] {};
\node (c) [treevertex,label=right:$c$,right=of a,shift={(-.5,0)},accepting] {};
\node (d) [treevertex,label=right:$d$,below right=of c,shift={(-.5,0)}] {};
%
\node[below left of=a,xshift=.25cm,yshift=.25cm] {$T_1$};
